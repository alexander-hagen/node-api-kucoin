...
KucoinPrivate.prototype.listAccounts = function(symbol,type) { // https://Kucoinapi.github.io/docs/spot/v1/en/#get-all-accounts-of-the-current-user
  var path="/api/v1/accounts",sep="?";
  if(symbol!==undefined) { path+=sep+"symbol="+symbol; sep="&"; };
  if(type!==undefined) { path+=sep+"type="+type; sep="&"; };
  return this.getQuery(path, {});
};
